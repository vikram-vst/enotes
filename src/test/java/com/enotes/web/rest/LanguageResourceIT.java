...
import com.enotes.repository.LanguageRepository;
...
public class LanguageResourceIT {
    ...
    private static final String DEFAULT_ISO_LANGUAGE_CODE = "AAAAAAAAAA";
    private static final String UPDATED_ISO_LANGUAGE_CODE = "BBBBBBBBBB";
    ...
    public static Language createEntity(EntityManager em) {
        Language language = new Language()
            .isoLanguageCode(DEFAULT_ISO_LANGUAGE_CODE)
            .name(DEFAULT_NAME);
        return language;
    }
    /**
    ...
    public static Language createUpdatedEntity(EntityManager em) {
        Language language = new Language()
            .isoLanguageCode(UPDATED_ISO_LANGUAGE_CODE)
            .name(UPDATED_NAME);
        return language;
    }
    ...
    public void createLanguage() throws Exception {
        ...
        assertThat(testLanguage.getIsoLanguageCode()).isEqualTo(DEFAULT_ISO_LANGUAGE_CODE);
    ...
    public void getAllLanguages() throws Exception {
        ...
        restLanguageMockMvc.perform(get("/api/languages?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].isoLanguageCode").value(hasItem(DEFAULT_ISO_LANGUAGE_CODE)))
    ...
    public void getLanguage() throws Exception {
        ...
        restLanguageMockMvc.perform(get("/api/languages/{id}", language.getId()))
            ...
            .andExpect(jsonPath("$.isoLanguageCode").value(DEFAULT_ISO_LANGUAGE_CODE))
    ...
    public void updateLanguage() throws Exception {
        ...
        Language testLanguage = languageList.get(languageList.size() - 1);
        assertThat(testLanguage.getIsoLanguageCode()).isEqualTo(UPDATED_ISO_LANGUAGE_CODE);
