...
describe('Service Tests', () => {
  describe('UserPreference Service', () => {
    ...
    let elemDefault: IUserPreference;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(UserPreferenceService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new UserPreference(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a UserPreference', () => {
        ...
        service.create(new UserPreference()).subscribe(resp => (expectedResult = resp.body));
