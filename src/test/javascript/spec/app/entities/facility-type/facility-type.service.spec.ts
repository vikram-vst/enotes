...
describe('Service Tests', () => {
  describe('FacilityType Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(FacilityTypeService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new FacilityType(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a FacilityType', () => {
        ...
        service.create(new FacilityType()).subscribe(resp => (expectedResult = resp.body));
